const navigateLinks = function (client, item, urlComponent, breadcrumbCSS, breadcrumbText, activeClass, panelCSS, panelText) {
    return client
        ...
        .verify.urlEquals('http://uat.assos.com/')
        .end();
}
...
module.exports = {
    'it Should navigate to the CUSTOMER SERVICE web page and back to Home page': client => {
        navigateLinks(client, 'a[href="/customer-service"]', '/customer-service', '.global-views-breadcrumb', 'HOME CUSTOMER SERVICE', '.customer-service .active', '.customer-anchor-item', 'CUSTOMER SERVICE');
    },
    ...
    //     navigateLinks(client, 'a[href="/product-care"]','/product-care','.global-views-breadcrumb', 'HOME PRODUCT CARE','.product-care.active', '.product-care', 'PRODUCT CARE');
    // },
    ...
    'it Should navigate to the PRIVACY web page and back to Home page': client => {
        navigateLinks(client, 'a[href="/privacy"]', '/privacy', '.global-views-breadcrumb', 'HOME PRIVACY', '.privacy-anchor-item.active', '.privacy-anchor-item','PRIVACY');
    },
    ...
    //     navigateLinks(client, 'a[href="/sitemap"]','/sitemap','.global-views-breadcrumb', 'HOME SITEMAP','.sitemap-anchor-item.active', '.sitemap-anchor-item', 'SITEMAP');
    // },
    ...
    'it Should click on the ASSOS logo in the footer, and redirect users to the HOME page': client => {
        client
          ...
          //  .getLocationInView('#site-footer')
           ...
           // .waitForElementVisible('.ditch-mobile .header-logo-image')
            .assert.urlContains('http://uat.assos.com/')
    },
