const username = 'bilal@paperplane.net';
...
module.exports = {
    ...
    'it Should throw VALIDATION ERROR message on TELEPHONE NUMBER if number of digits is less than 7': client => {
        client
            .goToMyAccount(username, password)
        ...
        client.getValue('input[type="tel"]', function (result) {
            ...
            if (tel_no_length < 7) {
                client
                    .click('.address-edit-form-button-submit.secondary-button')
                    .verify.containsText('div:nth-child(5) > div:nth-child(2) > div > div > p', 'phone number is invalid')
                    .end();
            }
    ...
    'WHEN NO ADDRESS in ADDRESS BOOK: it Should throw error messages when no value is entered and SAVE ADDRESS is Clicked': client => {
        client
            ...
            .waitForElementVisible('a[data-id="addressbook"]')
            .click('a[data-id="addressbook"]')
            .getLocationInView('.address-edit-form-button-submit.secondary-button')
            .click('.address-edit-form-button-submit.secondary-button')
            .verify.containsText('div:nth-child(2) > div:nth-child(1) > div > div > p', 'full Name is required')
            .verify.containsText('div:nth-child(2) > div:nth-child(2) > div > div > p', 'address is required')
            .verify.containsText('div:nth-child(3) > div:nth-child(2) > div > div > p', 'city is required')
            .verify.containsText('div:nth-child(4) > div:nth-child(1) > div > div > p', 'country is required')
            .verify.containsText('div:nth-child(5) > div:nth-child(1) > div > div > p', 'zip Code is required')
            .verify.containsText('div:nth-child(5) > div:nth-child(2) > div > div > p', 'phone is required')
            .pause(2000)
            .end();
        ...
        client
            ...
            .getText('div.shipping-address-container > div.address-list-default-addresses > div > div > div > div > div > div > div:nth-child(1) > address > div > h4', function (result) {
                ...
                if (fullname == fullnameNew) {
                    ...
                    client
                        .verify.containsText('div.shipping-address-container > div.address-list-default-addresses > div > div > div > div > div > div > div:nth-child(1) > address > div > h4', fullnameNew);
                }
            ...
            .getText('div.shipping-address-container > div.address-list-default-addresses > div > div > div > div > div > div > div:nth-child(1) > address > div > p.address-details-container-multiselect-address-details-addr1', function (result) {
                ...
                if (addr1 == addr1New) {
                    ...
                    client
                        .verify.containsText('div.shipping-address-container > div.address-list-default-addresses > div > div > div > div > div > div > div:nth-child(1) > address > div > p.address-details-container-multiselect-address-details-addr1', addr1New);
                }
            ...
            .getText('div.shipping-address-container > div.address-list-default-addresses > div > div > div > div > div > div > div:nth-child(1) > address > div > p.address-details-container-multiselect-address-details-addr2', function (result) {
                ...
                if (addr2 == addr2New) {
                    ...
                    client
                        .verify.containsText('div.shipping-address-container > div.address-list-default-addresses > div > div > div > div > div > div > div:nth-child(1) > address > div > p.address-details-container-multiselect-address-details-addr1', addr2New);
                }
            ...
            .getText('div.shipping-address-container p.address-details-country', function (result) {
                ...
                if (country == 'Albania') {
                    ...
                    client
                        .verify.containsText('div.shipping-address-container p.address-details-country', 'Albania');
                }
            ...
            .getText('div.shipping-address-container p.address-details-phone > a', function (result) {
                ...
                if (phone.match('/' + phonenoNew + '/g')) {
                    ...
                    client
                        .verify.containsText('div.shipping-address-container p.address-details-phone a', phonenoNew);
                }
